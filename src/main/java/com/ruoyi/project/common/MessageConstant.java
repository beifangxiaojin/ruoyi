...
public class MessageConstant {
    ...
    public static final String ADD_EMPLOYEE_SUCCESS = "新增人员项成功";
    public static final String ADD_EMPLOYEE_FAIL = "新增人员项失败";
    public static final String EDIT_EMPLOYEE_FAIL = "编辑人员项失败";
    public static final String EDIT_EMPLOYEE_SUCCESS = "编辑人员项成功";
    public static final String QUERY_EMPLOYEE_SUCCESS = "查询人员项成功";
    public static final String QUERY_EMPLOYEE_FAIL = "查询人员项失败";
    public static final String UPLOAD_SUCCESS = "上传成功";
    public static final String ADD_TEMPLATE_FAIL = "新增保险组失败";
    public static final String ADD_TEMPLATE_SUCCESS = "新增保险组成功";
    public static final String QUERY_TEMPLATE_SUCCESS = "查询保险组成功";
    public static final String QUERY_TEMPLATE_FAIL = "查询保险组失败";
    public static final String EDIT_TEMPLATE_FAIL = "编辑保险组失败";
    public static final String EDIT_TEMPLATE_SUCCESS = "编辑保险组成功";
    ...
    public static final String QUERY_ORDER_SUCCESS = "查询信息成功";
    public static final String QUERY_ORDER_FAIL = "查询信息失败";
